...
for (let hero of simpsons) {
    ...
    photo.className = 'card_photo';
    info.className = 'card_info';
    title.innerText = `${hero.name} ${hero.surname}`;
    info.innerText = hero.info;
    photo.src = hero.photo;
    photo.alt = 'ooppps something wrong'

    card.append(title, photo, info, );
...
coursesWrapper.className = 'courseContainer';
...
for (let item of coursesArray) {
    ...
    let title = document.createElement('h1');
    let monthElem = document.createElement('span');
    let hourElem = document.createElement('span');
    let subTitle = document.createElement('p');

    title.innerText = item.title;
    monthElem.innerText = `${item.monthDuration} місяців`;
    hourElem.innerText = `${item.hourDuration} годин`;

    subTitle.append(monthElem, hourElem);
    card.append(title, subTitle);
    card.appendChild(list);
    coursesWrapper.appendChild(card);
}
wrapper.appendChild(document.createElement('hr'))
wrapper.appendChild(coursesWrapper);
// ----------------------------------------------------------------------------------------------